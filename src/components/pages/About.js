    ...
    return (
        <>
            <div className="h-full min-h-screen flex items-center justify-center max-md:text-sm max-sm:text-xs transition-all duration-200 dark:bg-[#343541] dark:text-white py-20">
                <div className="w-2/3 min-h-[70vh] font-medium" id='skills-container'>
                    {/* title */}
                    <div className='text-center flex flex-col justify-center items-center'>
                        <div>
                            <h2 className='mb-5 pb-2 inline-block font-semibold text-3xl border-b-2 border-sky-600 dark:border-indigo-400'>
                                <FormattedMessage id='about'></FormattedMessage>
                            </h2>
                        </div>
                        <div>
                            <div>
                                <img src={avatar} alt="avatar" className='w-40 h-40 object-cover rounded-full mb-2 transition-all duration-300 hover:ring-2 hover:ring-indigo-400 dark:hover:ring-sky-600' />
                            </div>
                            {/* socials */}
