...
const Skills = () => {
    document.querySelector('title').innerText = "Projects"
    return (
        <>
            <div className="h-full min-h-screen flex items-center justify-center max-md:text-sm max-sm:text-xs transition-all duration-200 dark:bg-[#343541] dark:text-white py-20">
                <div className="w-2/3 max-sm:w-4/5 min-h-[70vh]">
                    ...
                    <div className='flex flex-col' id='links'>
                        ...
                        <NavLink to='personel-website' className="font-medium text-xl dark:hover:bg-slate-100 dark:hover:bg-opacity-10 hover:bg-opacity-20 p-1 mt-1 rounded hover:bg-slate-500">Personel Website</NavLink>
                        <main className='mt-2'>
                            <Outlet />
                        </main>
                    </div>
