        ...
        <div>
            <div className="border-2 p-3 rounded border-sky-600 dark:border-indigo-400 my-2 hover:shadow-xl dark:hover:border-purple-400 hover:border-blue-400 transition-transform">
                <div className="flex items-center">
                    <div>
                        <h2>Color Changer React.js</h2>
                    </div>
                    <div className="text-red-400 dark:text-[#F06D65]">
                        <a href='https://github.com/alper-demir/ColorChanger' target='_blank' rel="noreferrer">
                ...
                <div>
                    <p className="mt-1">
                        <FormattedMessage id="color-changer-react"></FormattedMessage>
                    </p>
                </div>
...
export default ColorChangerReact